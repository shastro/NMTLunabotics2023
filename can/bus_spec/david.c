    ...
    size_t size)
{
    ...
    dst_p->left_power = unpack_right_shift_u16(src_p[0], 0u, 0xffu);
    dst_p->left_power |= unpack_left_shift_u16(src_p[1], 8u, 0xffu);
    dst_p->right_power = unpack_right_shift_u16(src_p[2], 0u, 0xffu);
    dst_p->right_power |= unpack_left_shift_u16(src_p[3], 8u, 0xffu);
    ...
    size_t size)
{
    ...
    dst_p[0] |= pack_left_shift_u16(src_p->power, 2u, 0xfcu);
    dst_p[1] |= pack_right_shift_u16(src_p->power, 6u, 0xffu);
    dst_p[2] |= pack_right_shift_u16(src_p->power, 14u, 0x03u);
    ...
    size_t size)
{
    ...
    dst_p->power = unpack_right_shift_u16(src_p[0], 2u, 0xfcu);
    dst_p->power |= unpack_left_shift_u16(src_p[1], 6u, 0xffu);
    dst_p->power |= unpack_left_shift_u16(src_p[2], 14u, 0x03u);
