...
class ControllerCommandMsg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ControllerCommandMsg(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ControllerCommandMsg(null);
...
ControllerCommandMsg.Constants = {
  START_TRACKING: 0,
  STOP_TRACKING: 1,
}

module.exports = ControllerCommandMsg;
